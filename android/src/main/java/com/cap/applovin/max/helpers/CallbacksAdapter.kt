...
import com.cap.applovin.max.R
import com.cap.applovin.max.models.CallbackDataItem
import java.util.*

class CallbacksAdapter internal constructor(context: Context) :
    RecyclerView.Adapter<CallbacksAdapter.ViewHolder>() {
    private val backgroundLight: Int = ContextCompat.getColor(context, R.color.colorPrimary)
    private val backgroundDark: Int = ContextCompat.getColor(context, R.color.colorPrimaryDark)
